...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
			a demo for everyone,but I only try to push the demo to gits
                   DESC
  ...
  # Or just: s.author    = "taotao361"
  # s.authors            = { "taotao361" => "yangxutao361@163.com" }
  # s.social_media_url   = "http://twitter.com/taotao361"
